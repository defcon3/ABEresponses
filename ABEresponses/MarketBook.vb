...
Public Class MarketBook
    ...
    Public Property isMarketDataDelayed As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ''' <returns>The status of the market, for example OPEN, SUSPENDED, CLOSED (settled), etc.</returns>
    Public Property status As clsEnumerations.MarketStatus
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ...
    Public Property bspReconciled As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ''' <returns>If false, runners may be added to the market</returns>
    Public Property complete As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ''' <returns>True if the market is currently in play</returns>
    Public Property inplay As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ...
    Public Property totalMatched As System.Double = 0
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ''' <returns>The total amount of orders that remain unmatched</returns>
    Public Property totalAvailable As System.Double = 0
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ''' <returns>True if cross matching is enabled for this market.</returns>
    Public Property crossMatching As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ...
    Public Property runnersVoidable As System.Boolean = True
    ''' <summary>
    ''' Field optional
    ''' </summary>
    ...
    Public Property keyLineDescription As KeyLineDescription
End Class
