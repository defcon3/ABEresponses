...
Public Class RunnerMetadataDescription
    ...
    Public Function getnode() As System.Windows.Forms.TreeNode
        ...
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "Zeitstempel: " & DateAndTime.Now, .Tag = DateAndTime.Now, .Name = "RUNNERMETADATADESCRIPTION_ZEITSTEMPEL"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "WEIGHT_UNITS: " & WEIGHT_UNITS, .Tag = WEIGHT_UNITS, .Name = "RUNNERMETADATADESCRIPTION_WEIGHT_UNITS"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "ADJUSTED_RATING: " & ADJUSTED_RATING, .Tag = ADJUSTED_RATING, .Name = "RUNNERMETADATADESCRIPTION_ADJUSTED_RATING"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAM_YEAR_BORN: " & DAM_YEAR_BORN, .Tag = DAM_YEAR_BORN, .Name = "RUNNERMETADATADESCRIPTION_DAM_YEAR_BORN"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAYS_SINCE_LAST_RUN: " & DAYS_SINCE_LAST_RUN, .Tag = DAYS_SINCE_LAST_RUN, .Name = "RUNNERMETADATADESCRIPTION_DAYS_SINCE_LAST_RUN"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "WEARING: " & WEARING, .Tag = WEARING, .Name = "RUNNERMETADATADESCRIPTION_WEARING"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAMSIRE_YEAR_BORN: " & DAMSIRE_YEAR_BORN, .Tag = DAMSIRE_YEAR_BORN, .Name = "RUNNERMETADATADESCRIPTION_DAMSIRE_YEAR_BORN"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "SIRE_BRED: " & SIRE_BRED, .Tag = SIRE_BRED, .Name = "RUNNERMETADATADESCRIPTION_SIRE_BRED"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "TRAINER_NAME: " & TRAINER_NAME, .Tag = TRAINER_NAME, .Name = "RUNNERMETADATADESCRIPTION_TRAINER_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "STALL_DRAW: " & STALL_DRAW, .Tag = STALL_DRAW, .Name = "RUNNERMETADATADESCRIPTION_STALL_DRAW"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "SEX_TYPE: " & SEX_TYPE, .Tag = SEX_TYPE, .Name = "RUNNERMETADATADESCRIPTION_SEX_TYPE"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "OWNER_NAME: " & OWNER_NAME, .Tag = OWNER_NAME, .Name = "RUNNERMETADATADESCRIPTION_OWNER_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "SIRE_NAME: " & SIRE_NAME, .Tag = SIRE_NAME, .Name = "RUNNERMETADATADESCRIPTION_SIRE_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "FORECASTPRICE_NUMERATOR: " & FORECASTPRICE_NUMERATOR, .Tag = FORECASTPRICE_NUMERATOR, .Name = "RUNNERMETADATADESCRIPTION_FORECASTPRICE_NUMERATOR"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "FORECASTPRICE_DENOMINATOR: " & FORECASTPRICE_DENOMINATOR, .Tag = FORECASTPRICE_DENOMINATOR, .Name = "RUNNERMETADATADESCRIPTION_FORECASTPRICE_DENOMINATOR"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "JOCKEY_CLAIM: " & JOCKEY_CLAIM, .Tag = JOCKEY_CLAIM, .Name = "RUNNERMETADATADESCRIPTION_JOCKEY_CLAIM"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "WEIGHT_VALUE: " & WEIGHT_VALUE, .Tag = WEIGHT_VALUE, .Name = "RUNNERMETADATADESCRIPTION_WEIGHT_VALUE"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAM_NAME: " & DAM_NAME, .Tag = DAM_NAME, .Name = "RUNNERMETADATADESCRIPTION_DAM_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "AGE: " & AGE, .Tag = AGE, .Name = "RUNNERMETADATADESCRIPTION_AGE"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "COLOUR_TYPE: " & COLOUR_TYPE, .Tag = COLOUR_TYPE, .Name = "RUNNERMETADATADESCRIPTION_COLOUR_TYPE"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAMSIRE_BRED: " & DAMSIRE_BRED, .Tag = DAMSIRE_BRED, .Name = "RUNNERMETADATADESCRIPTION_DAMSIRE_BRED"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAMSIRE_NAME: " & DAMSIRE_NAME, .Tag = DAMSIRE_NAME, .Name = "RUNNERMETADATADESCRIPTION_DAMSIRE_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "SIRE_YEAR_BORN: " & SIRE_YEAR_BORN, .Tag = SIRE_YEAR_BORN, .Name = "RUNNERMETADATADESCRIPTION_SIRE_YEAR_BORN"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "OFFICIAL_RATING: " & OFFICIAL_RATING, .Tag = OFFICIAL_RATING, .Name = "RUNNERMETADATADESCRIPTION_OFFICIAL_RATING"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "FORM: " & FORM, .Tag = FORM, .Name = "RUNNERMETADATADESCRIPTION_FORM"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "BRED: " & BRED, .Tag = BRED, .Name = "RUNNERMETADATADESCRIPTION_BRED"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "runnerId: " & runnerId, .Tag = runnerId, .Name = "RUNNERMETADATADESCRIPTION_RUNNERID"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "JOCKEY_NAME: " & JOCKEY_NAME, .Tag = JOCKEY_NAME, .Name = "RUNNERMETADATADESCRIPTION_JOCKEY_NAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "DAM_BRED: " & DAM_BRED, .Tag = DAM_BRED, .Name = "RUNNERMETADATADESCRIPTION_DAM_BRED"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "COLOURS_DESCRIPTION: " & COLOURS_DESCRIPTION, .Tag = COLOURS_DESCRIPTION, .Name = "RUNNERMETADATADESCRIPTION_COLOURS_DESCRIPTION"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "COLOURS_FILENAME: " & COLOURS_FILENAME, .Tag = COLOURS_FILENAME, .Name = "RUNNERMETADATADESCRIPTION_COLOURS_FILENAME"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "CLOTH_NUMBER: " & CLOTH_NUMBER, .Tag = CLOTH_NUMBER, .Name = "RUNNERMETADATADESCRIPTION_CLOTH_NUMBER"})
        newnode.Nodes.Add(New System.Windows.Forms.TreeNode With {.Text = "CLOTH_NUMBER_ALPHA: " & CLOTH_NUMBER_ALPHA, .Tag = CLOTH_NUMBER_ALPHA, .Name = "RUNNERMETADATADESCRIPTION_CLOTH_NUMBER_ALPHA"})
